-- =====================================================================
-- 2026-05-20_tournament-v3-class-by-category.sql
--
-- TournamentClass を「性別グループ × クラス」から
-- 「種目 (category) × クラス + 行単位の承認ステータス」に作り直す。
--
-- 既存 DEV データはまだ捨てて構わない前提なので、Tournament 系を
